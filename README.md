...
1. Указать приватный ключ аккаунта релейера в файле `relayer.py`
2. Пополнить этот аккаунт ETH в сети L1 (можно использовать любой аккаунт, даже не связанный с деплоем)
